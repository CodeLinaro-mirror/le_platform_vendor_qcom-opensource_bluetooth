...
#ifndef ANDROID
#define BTA_AVK_RC_SUPF_CT       (AVRC_SUPF_CT_CAT1 | AVRC_SUPF_CT_APP_SETTINGS)
#else
#if AVRC_METADATA_INCLUDED == TRUE

#if AVCT_BROWSE_INCLUDED == TRUE
#if (defined(AVCT_COVER_ART_INCLUDED) && (AVCT_COVER_ART_INCLUDED == TRUE))
#define BTA_AVK_RC_SUPF_TG       (AVRC_SUPF_TG_CAT1 | AVRC_SUPF_TG_APP_SETTINGS | AVRC_SUPF_TG_PLAYER_COVER_ART)
#else
